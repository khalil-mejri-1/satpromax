                ...
                <div className="container">
                    ...
                    <div className="product-detail-grid">
                        ...
                        <div className="product-info-section">
                            ...
                            {(isIPTVCategory || product.hasTest) && (
                                <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap' }}>
                                    ...
                                    {product.hasTest && (
                                        <button
                                            onClick={() => {
                                                const msg = `Bonjour, je voudrais Demander un test gratuit 24 heures pour ${product.name}`;
                                        ...
                                        >
                                            ...
                                            <h6 style={{ margin: 0, fontSize: 'inherit', color: 'inherit', fontWeight: 'inherit' }}>Demander un test gratuit 24 heures</h6>
                                        </button>
                                    )}
                                </div>
                            )}
