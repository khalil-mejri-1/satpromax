                            ...
                            {(isIPTVCategory || product.hasTest) && (
                                <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap' }}>
                                    ...
                                    {product.hasTest && (
                                        <button
                                            onClick={() => {
                                                const msg = `Bonjour, je voudrais demander un test gratuit 2 jours pour ${product.name}`;
                                        ...
                                        >
                                            ...
                                            <h6 style={{ margin: 0, fontSize: 'inherit', color: 'inherit', fontWeight: 'inherit' }}>Demander un test gratuit 2 jours</h6>
                                        </button>
                                    )}
                                </div>
                            )}
